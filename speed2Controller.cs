...
public class speed2Controller : MonoBehaviour {
    GameObject Player;
    GameObject lefteye;
    GameObject Head;
    GameObject Body;
    ...
    void Start () {
        this.lefteye = GameObject.Find("K_Adj_L_FaceEye");
        this.Head = GameObject.Find("K_Bip_C_Head");
        this.Body = GameObject.Find("K_Bip_C_Spine");
        this.Player = GameObject.Find("Linda2");
    }
	...
	void Update () {
        ...
        //時間の取得
        double t = target_directer2.Gett();
        ...
        double EmaxX = hi_body2.GetBx() + hi_eye2.GetEx() + hi_head2.GetHx() + Playerx + dx + dhx;
        double EmaxY = hi_body2.GetBy() + hi_eye2.GetEy() + hi_head2.GetHy() + Playery + dy + dhy;
        ...
        double Hthx = hi_body2.GetBx() + hi_head2.GetHx() + Playerx + dhx;
        double Hthy = hi_body2.GetBx() + hi_head2.GetHy() + Playery + dhy;
        ...
        double Btax = hi_body2.GetBx() + Playerx;
        double Btay = hi_body2.GetBy() + Playery;
